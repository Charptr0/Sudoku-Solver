    ...
    return (
            ...
            <Options solve={solve} />
                ...
                <tbody>
                        ...
                        <tr>
                                <td><input id="r1c0" type={"number"} min={1} max={9}></input></td> 
                        ...
                        <tr>
                                <td><input id="r2c0" type={"number"} min={1} max={9}></input></td> 
                ...
                <tbody>
                        <tr>
                                <td><input id="r3c0" type={"number"} min={1} max={9}></input></td> 
                        ...
                        <tr>
                                <td><input id="r4c0" type={"number"} min={1} max={9}></input></td> 
                        ...
                        <tr>
                                <td><input id="r5c0" type={"number"} min={1} max={9}></input></td> 
                    ...
                    <tbody>
                        <tr>
                                <td><input id="r6c0" type={"number"} min={1} max={9}></input></td> 
                        ...
                        <tr>
                                <td><input id="r7c0" type={"number"} min={1} max={9}></input></td> 
                        ...
                        <tr>
                                <td><input id="r8c0" type={"number"} min={1} max={9}></input></td> 
